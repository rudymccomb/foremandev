...
#
class hardened::modprobe {
  # GuideSection 2.2.2.2.1 2.5.3.1.1, 2.2.2.5, 3.3.14.3
  # Disable modprobe loading of usb-storage and unused file systems
        #modprobe::disableModule{"Disable Cramfs, 2.2.2.5":   	module => "cramfs" } #may not be installed
        #modprobe::disableModule{"Disable freevxfs, 2.2.2.5": 	module => "freevxfs" } #may not be installed
        #modprobe::disableModule{"Disable jffs2, 2.2.2.5":    	module => "jffs2" } #may not be installed
        #modprobe::disableModule{"Disable hfs, 2.2.2.5":      	module => "hfs" } #may not be installed
        #modprobe::disableModule{"Disable hfsplus, 2.2.2.5":  	module => "hfsplus" } #may not be installed
        #modprobe::disableModule{"Disable udf, 2.2.2.5":      	module => "udf" } #may not be installed
        #modprobe::disableModule{"Disable usb-storage, 2.2.2.1":	module => "usb-storage" } #may not be installed
        #modprobe::disableModule{"Disable ipv6, 2.5.3.1.1":	module => "ipv6" } #may not be installed
  ...
  # Disabling due to puppet bleedover 
